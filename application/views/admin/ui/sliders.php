  ...
  <!-- ion slider Nice -->
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/ionslider/ion.rangeSlider.skinNice.css">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="<?= base_url() ?>public/plugins/bootstrap-slider/slider.css">
...
<!-- Ion Slider -->
<script src="<?= base_url() ?>public/plugins/ionslider/ion.rangeSlider.min.js"></script>
<!-- Bootstrap slider -->
<script src="<?= base_url() ?>public/plugins/bootstrap-slider/bootstrap-slider.js"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider();
